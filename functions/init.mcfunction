summon artifact:countdown
scoreboard objectives add is_frozen dummy
scoreboard objectives add is_powerful dummy
scoreboard objectives add is_snowing dummy
